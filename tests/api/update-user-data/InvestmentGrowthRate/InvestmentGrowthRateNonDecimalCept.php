<?php 
    ...
    $I->wantTo('Update investment_growth_rate with non-decimal');
    ...
    $I->dontSeeInDatabase('users', array('email' => 'test1@test.com', 'investment_growth_rate' => 5));
?>